...
public class FinalDecoding {
    public static void main(String[] args) {
        ...
        // Setting up a supercipher object to decrypt messages.
        BaseCipher[] cipherChain = {
        new WordReplacementCipher("world","neighborhood"),
        new WordReplacementCipher("enigma device","grill"),
        new WordReplacementCipher("fort knox","my garage"),
        new WordReplacementCipher("omni-matrix","propane-tank"),
        new WordReplacementCipher("my garage", "fort knox"),
        new EvenOddCipher(), new CaesarCipher(5)
        };
